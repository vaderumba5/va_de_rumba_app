...
import 'web_gallery_screen.dart';
  ...
  _Page _pageFor(AppSection section) {
    switch (section) {
      ...
      case AppSection.webPublishing:
        return const _Page(
          'Publicación web',
          'Selecciona qué conciertos aparecen en la web',
          PublicConcertsScreen(),
        );
      case AppSection.webGallery:
        return const _Page(
          'Galería web',
          'Fotografías de «Fuera y dentro del escenario»',
          WebGalleryScreen(),
        );
...
extension on AppSection {
  String get module => switch (this) {
        ...
        AppSection.webGallery => AppModules.concerts,
